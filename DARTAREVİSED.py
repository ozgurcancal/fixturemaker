...
class dart:
    ...
    def dortartıbir(self): ##dördün katları veya katlarının bir fazlasıysa
        guys=self.guys
        count=self.count
    ...
    def ucartıbir(self): ##üçün katları veya katlarının bir fazlasıysa
        guys=self.guys
        count=self.count
...
X=["ÖZGÜR","HATEM","MUHAMMED","CUMAALİ","NAZLI","EMRAH","EMRE","CENGİZ"]
t.karistir(X)
...
##################################### gruplar hazır şimdi kendi içinde karıp eşleştireceksin


 


for i in range(count):  ##bütün gruplar çift elemanlı artık fazlalıkları havuzliste attık
   ...
   ###havuz listi grup olarak yazdır tekse birini  üsttura at.ilk grup sayısı ile aynı yeni gruplar oluştur.
...
print()
harf=["A","B","C","D","E","F"] ###grupları yazdırıp grup isimlerini bir üst tura atadık
